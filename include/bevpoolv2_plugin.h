...
namespace
{
static const char *TRTBEVPoolV2_PLUGIN_VERSION{"1"};
static const char *TRTBEVPoolV2_PLUGIN_NAME{"bev_pool_v2"};
} // namespace
...
public:
    TRTBEVPoolV2() = delete;
    TRTBEVPoolV2(const std::string &name, int bev_h, int bev_w, int n);
    TRTBEVPoolV2(const std::string &name, const void *buffer, size_t length);
    ~TRTBEVPoolV2();
