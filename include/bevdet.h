...
private:
    bool is_load_input_from_torch;
    bool is_result_save;
    std::string debug_in_from_torch_path;
    std::string debug_file_save_path;
    ...
    int occ_class_num;
    std::vector<int> occ_class_num_pre_task;
    ...
    std::unique_ptr<PreprocessGPU>  preprocess_ptr;
    std::unique_ptr<PostprocessGPU> postprocess_ptr;
    // std::unique_ptr<OccPostprocessGPU> occ_postprocess_ptr;
